// Shared inline SVGs lifted from the original feed.html theme so the JSX
// components below don't repeat them. Purely presentational.
...
// The four post-dropdown menu rows share the same little blue glyphs.
