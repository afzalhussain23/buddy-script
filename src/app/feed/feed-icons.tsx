...
// Pencil glyph that sits beside the "Write something ..." placeholder label.
...
// Paper-plane glyph shown inside the "Post" submit button.
...
// Photo glyph for the create-post "Photo" action.
...
// Video glyph for the create-post "Video" action.
...
// Calendar glyph for the create-post "Event" action.
...
// Document glyph for the create-post "Article" action.
...
// Explore sidebar rows: each label has its own glyph, two are tagged "New".
